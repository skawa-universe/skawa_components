...
@Task('compile scss')
Future sass() async {
  ang.config.sassBuildConfig.package = 'skawa_materialish_components';
...
Future checkimport() async {
  ang.config.importOptimize.packagesToCheck = ['skawa_materialish_components'];
  await ang.checkImport();
}

@Task('watch scss')
Future sasswatch() async {
  ang.config.sassWatchConfig.package = 'skawa_materialish_components';
