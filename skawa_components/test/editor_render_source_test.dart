...
//    <textarea editorRenderSource [initialValue]="initialValue" [updateDelay]="updateDelay" (update)="update(\$event)"></textarea>
...
//
//  Future clear() async => await editorRenderSource.clear();
//
//  Future type(String s) async => await editorRenderSource.type(s);
//
