...
//
//part of 'sidebar_item_test.dart';
//
//// **************************************************************************
//// PageObjectGenerator
//// **************************************************************************
...
//      __listener.startPageObjectMethod('TestPO', 'sideBarItemList');
//    }
//    final element =
//        $__root__.createElement(ByTagName('skawa-sidebar-item'), [], []);
//    final returnMe = SidebarItemPO.create(element);
//    for (final __listener in $__root__.listeners) {
//      __listener.endPageObjectMethod('TestPO', 'sideBarItemList');
//    }
//    return returnMe;
//  }
//}
...
//    for (final __listener in $__root__.listeners) {
//      __listener.startPageObjectMethod('SidebarItemPO', 'rootElement');
//    }
//    final element = $__root__;
//    final returnMe = element;
//    for (final __listener in $__root__.listeners) {
//      __listener.endPageObjectMethod('SidebarItemPO', 'rootElement');
//    }
//    return returnMe;
//  }
//
